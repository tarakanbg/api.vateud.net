class EmailsController < ApplicationController
  ...
  def show
    ...
    @members = Member.where(["subdivision = ?", params[:id]]).select("cid, firstname, lastname, email, rating, pilot_rating, country, subdivision, reg_date, susp_ends").reorder("reg_date DESC")

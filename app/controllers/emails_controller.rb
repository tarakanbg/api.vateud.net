class EmailsController < ApplicationController
  ...
  def show    
    ...
    @members = Member.where(["subdivision = ?", params[:id].upcase]).select("cid, firstname, lastname, email,
      rating, humanized_atc_rating, pilot_rating, humanized_pilot_rating, country, subdivision, reg_date,
      susp_ends").reorder("reg_date DESC")
